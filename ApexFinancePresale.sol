...
contract APEXFinancePresale is Context, Ownable {
  ...
  constructor(bool _seed,address _token,address _busd,uint256 _price,uint256 _minbuy,uint256 _maxsold,uint256 _maxhold,address _recaiver,bool _burn) public {
      saletoken = _token;
      //APEX TOKEN PRESALE
      busd = _busd;
      //BUSD REQUIRE
